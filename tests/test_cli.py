    ...
    try:
        ...
        with cd("tmp/test_cli/MyApp"):
            ...
            with cd("android/app/src/"):
                for source in [
                    "main/java/com/mycompany/myapp/MainActivity.java",
                    ...
                    assert (
                        found
                    ), "Init didn't properly rename the java package in {}".format(
                        source
                    )
                ...
                ), "AndroidManifest was not copied"
                found = False
            ...
            with source_activated("venv", "enaml-native") as enamlnative:
                ...
                print(output)
                assert (
                    "Finalizing the Python interpreter" not in output
                ), "run-android failed:" "{}".format(output)
